...
import org.brewchain.backend.ordbgens.bc.entity.BCMtxInputExample.Criterion;
import org.brewchain.backend.ordbgens.bc.entity.BCMtxInputExample;

public class BCMtxInputSqlProvider {
     ...
     */
    public String countByExample(BCMtxInputExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("BC_MTX_INPUT");
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String deleteByExample(BCMtxInputExample example) {
        BEGIN();
        DELETE_FROM("BC_MTX_INPUT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String insertSelective(BCMtxInput record) {
        BEGIN();
        INSERT_INTO("BC_MTX_INPUT");
        
        if (record.getMtxInputid() != null) {
            VALUES("MTX_INPUTID", "#{mtxInputid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getBcNonce() != null) {
            VALUES("BC_NONCE", "#{bcNonce,jdbcType=INTEGER}");
        }
        ...
        if (record.getCryptoTokenHex() != null) {
            VALUES("CRYPTO_TOKEN_HEX", "#{cryptoTokenHex,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String selectByExample(BCMtxInputExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("MTX_INPUTID");
        } else {
            SELECT("MTX_INPUTID");
        }
        SELECT("BC_ADDRESS");
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("BC_MTX_INPUT");				applyWhere(example, false);
		}
        if(example != null){
            String sql = SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BCMtxInput record = (BCMtxInput) parameter.get("record");
        BCMtxInputExample example = (BCMtxInputExample) parameter.get("example");
        
        BEGIN();
        UPDATE("BC_MTX_INPUT");
        
        if (record.getMtxInputid() != null) {
            SET("MTX_INPUTID = #{record.mtxInputid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getBcNonce() != null) {
            SET("BC_NONCE = #{record.bcNonce,jdbcType=INTEGER}");
        }
        ...
        if (record.getCryptoTokenHex() != null) {
            SET("CRYPTO_TOKEN_HEX = #{record.cryptoTokenHex,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String updateByPrimaryKeySelective(BCMtxInput record) {
        BEGIN();
        UPDATE("BC_MTX_INPUT");
        ...
        if (record.getBcNonce() != null) {
            SET("BC_NONCE = #{bcNonce,jdbcType=INTEGER}");
        }
        ...
        if (record.getCryptoTokenHex() != null) {
            SET("CRYPTO_TOKEN_HEX = #{cryptoTokenHex,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    protected void applyWhere(BCMtxInputExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
