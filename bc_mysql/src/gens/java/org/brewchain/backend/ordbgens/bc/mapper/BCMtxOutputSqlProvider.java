...
import org.brewchain.backend.ordbgens.bc.entity.BCMtxOutputExample.Criterion;
import org.brewchain.backend.ordbgens.bc.entity.BCMtxOutputExample;

public class BCMtxOutputSqlProvider {
     ...
     */
    public String countByExample(BCMtxOutputExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("BC_MTX_OUTPUT");
     ...
     * @mbggenerated Tue Aug 21 20:51:20 CST 2018
     */
    public String deleteByExample(BCMtxOutputExample example) {
        BEGIN();
        DELETE_FROM("BC_MTX_OUTPUT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Aug 21 20:51:20 CST 2018
     */
    public String insertSelective(BCMtxOutput record) {
        BEGIN();
        INSERT_INTO("BC_MTX_OUTPUT");
        
        if (record.getMtxOutputid() != null) {
            VALUES("MTX_OUTPUTID", "#{mtxOutputid,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:51:20 CST 2018
     */
    public String selectByExample(BCMtxOutputExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("MTX_OUTPUTID");
        } else {
            SELECT("MTX_OUTPUTID");
        }
        SELECT("BC_ADDRESS");
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("BC_MTX_OUTPUT");				applyWhere(example, false);
		}
        if(example != null){
            String sql = SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BCMtxOutput record = (BCMtxOutput) parameter.get("record");
        BCMtxOutputExample example = (BCMtxOutputExample) parameter.get("example");
        
        BEGIN();
        UPDATE("BC_MTX_OUTPUT");
        
        if (record.getMtxOutputid() != null) {
            SET("MTX_OUTPUTID = #{record.mtxOutputid,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:51:20 CST 2018
     */
    public String updateByPrimaryKeySelective(BCMtxOutput record) {
        BEGIN();
        UPDATE("BC_MTX_OUTPUT");
     ...
     * @mbggenerated Tue Aug 21 20:51:20 CST 2018
     */
    protected void applyWhere(BCMtxOutputExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
