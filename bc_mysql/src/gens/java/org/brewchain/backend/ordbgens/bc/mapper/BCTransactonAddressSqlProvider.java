...
import org.brewchain.backend.ordbgens.bc.entity.BCTransactonAddressExample.Criterion;
import org.brewchain.backend.ordbgens.bc.entity.BCTransactonAddressExample;

public class BCTransactonAddressSqlProvider {
     ...
     */
    public String countByExample(BCTransactonAddressExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String deleteByExample(BCTransactonAddressExample example) {
        BEGIN();
        DELETE_FROM("BC_TRANSACTON_ADDRESS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String insertSelective(BCTransactonAddress record) {
        BEGIN();
        INSERT_INTO("BC_TRANSACTON_ADDRESS");
        ...
        if (record.getPrevTxid() != null) {
            VALUES("PREV_TXID", "#{prevTxid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getAddrType() != null) {
            VALUES("ADDR_TYPE", "#{addrType,jdbcType=CHAR}");
        }
        
        if (record.getNextScriptId() != null) {
            VALUES("NEXT_SCRIPT_ID", "#{nextScriptId,jdbcType=VARCHAR}");
        }
        
        if (record.getSvalue() != null) {
            VALUES("SVALUE", "#{svalue,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String selectByExample(BCTransactonAddressExample example) {
        BEGIN();
		...
		if (example != null && example.isDistinct()) {
			SELECT_DISTINCT(example.getSelectCols());
				...
				FROM("BC_TRANSACTON_ADDRESS");				applyWhere(example, false);
		}
        if(example != null){
            String sql = SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BCTransactonAddress record = (BCTransactonAddress) parameter.get("record");
        BCTransactonAddressExample example = (BCTransactonAddressExample) parameter.get("example");
        ...
        if (record.getPrevTxid() != null) {
            SET("PREV_TXID = #{record.prevTxid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getAddrType() != null) {
            SET("ADDR_TYPE = #{record.addrType,jdbcType=CHAR}");
        }
        
        if (record.getNextScriptId() != null) {
            SET("NEXT_SCRIPT_ID = #{record.nextScriptId,jdbcType=VARCHAR}");
        }
        
        if (record.getSvalue() != null) {
            SET("SVALUE = #{record.svalue,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    public String updateByPrimaryKeySelective(BCTransactonAddress record) {
        BEGIN();
        UPDATE("BC_TRANSACTON_ADDRESS");
        ...
        if (record.getPrevTxid() != null) {
            SET("PREV_TXID = #{prevTxid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getNextScriptId() != null) {
            SET("NEXT_SCRIPT_ID = #{nextScriptId,jdbcType=VARCHAR}");
        }
        
        if (record.getSvalue() != null) {
            SET("SVALUE = #{svalue,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Aug 21 20:42:28 CST 2018
     */
    protected void applyWhere(BCTransactonAddressExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
